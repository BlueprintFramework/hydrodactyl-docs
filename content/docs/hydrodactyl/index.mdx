...
Unless explicitly stated otherwise, all source code within the BlueprintFramework/hydrodactyl GitHub repository is licensed under the Apache License 2.0.

Hydrodactyl's website and documentation, hosted on the BlueprintFramework/hydrodactyl-docs GitHub repository, are licensed under the AGPL-3.0 license.
