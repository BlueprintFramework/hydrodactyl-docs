...
### Database Setup
  ...
  ```
### Add The First User
You'll then log into the panel via a web browser to create the initial administrator account. With no accounts on the system yet, the panel's builtin initial admin creation suite will guide you through the process on your first visit. At this time passwords must meet the following requirements: 8 characters, mixed case, at least one number.
