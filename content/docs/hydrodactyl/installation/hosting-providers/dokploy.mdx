...
<Callout type="note">
  ...
  guide](/docs/hydrodactyl/migrations).
</Callout>
...
- Once deployed, visit the panel at the configured domain/IP
- With no accounts on the system yet, the panel's builtin initial admin creation suite will guide you through creating the first administrator account
