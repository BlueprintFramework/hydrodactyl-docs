...
<Callout type="note">
  The guide for migration has moved to a [new page](/docs/hydrodactyl/migrations).
</Callout>
...
1. Open the panel via your server's IP address or domain in a web browser. With no accounts on the system yet, the panel's builtin initial admin creation suite will guide you through creating the first administrator account.

1. Check that the panel remains accessible using the IP address or domain of your server.
